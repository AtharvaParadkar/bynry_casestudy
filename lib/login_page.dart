...
import 'package:bynry_casestudy/dashboard.dart';
import 'package:bynry_casestudy/register_page.dart';
...
class _LoginPageState extends State<LoginPage> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      backgroundColor: const Color.fromARGB(255, 82, 1, 230),
      body: Padding(
                          ...
                          children: [
                            TextButton(
                              ...
                              child: const Text(
                                'Forgot Password?',
                                style: TextStyle(
                                  color: Color.fromRGBO(0, 0, 0, 0.441),
